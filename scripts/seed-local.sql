...
insert into life_period (person_id, label, from_edtf, to_edtf, from_year, to_year, sort_order) select id, '결혼 이후', '1988', null, 1988, null, 2 from pkey where key = 'dad';
...
insert into life_period (person_id, label, from_edtf, to_edtf, from_year, to_year, sort_order) select id, '결혼 이후', '1988', null, 1988, null, 1 from pkey where key = 'mom';
...
-- ---------------------------------------------------------------- 주제분류
-- 두 단계까지만. 부모가 없으면 상위, 있으면 하위다.
insert into subject (label, sort_order) values ('명절·기념일', 0);
insert into subject (parent_id, label, sort_order) select id, '어린이날', 0 from subject where label = '명절·기념일' and parent_id is null;
insert into subject (parent_id, label, sort_order) select id, '추석', 1 from subject where label = '명절·기념일' and parent_id is null;
insert into subject (parent_id, label, sort_order) select id, '돌', 2 from subject where label = '명절·기념일' and parent_id is null;
insert into subject (label, sort_order) values ('혼례', 1);
insert into subject (label, sort_order) values ('학교', 2);
insert into subject (label, sort_order) values ('군 생활', 3);
insert into subject (label, sort_order) values ('음식', 4);
insert into subject (label, sort_order) values ('이사', 5);
insert into subject (label, sort_order) values ('여행', 6);
insert into subject (label, sort_order) values ('상례', 7);
insert into subject (label, sort_order) values ('피란', 8);
insert into subject (label, sort_order) values ('인물 사진', 9);

-- ---------------------------------------------------------------- 수집과 묶음
insert into acquisition (visited_on, location, note) values ('2026-02-11', '서울', '설에 내려가 할머니 댁 자료를 훑고 구술을 녹음했다.');
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '2026년 설', 'folder'::bundle_kind, '구술 채록', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '안동군청', 'folder'::bundle_kind, '기관 발급', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '거실 장식장', 'folder'::bundle_kind, '부모님댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '결혼 앨범', 'album'::bundle_kind, '부모님댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '서재 문갑', 'folder'::bundle_kind, '부모님댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '앨범 1권', 'album'::bundle_kind, '부모님댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '앨범 2권', 'album'::bundle_kind, '부모님댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '컴퓨터 폴더', 'folder'::bundle_kind, '부모님댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '문갑 서랍', 'folder'::bundle_kind, '외갓집', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '앨범 3권', 'album'::bundle_kind, '외갓집', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '큰이모 앨범', 'album'::bundle_kind, '친척 기증', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '부엌 찬장', 'folder'::bundle_kind, '할머니댁', 'family', null from acquisition limit 1;
insert into bundle (acquisition_id, title, kind, source, default_access_level, note) select id, '안방 장롱', 'folder'::bundle_kind, '할머니댁', 'family', null from acquisition limit 1;
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 0, '외할아버지 제대', 'Event', '1953', '1953-01-01', '1953-12-31', 'year'::date_precision, false, false, false, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 1, '아버지 태어남', 'Event', '1960', '1960-01-01', '1960-12-31', 'year'::date_precision, false, false, false, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 2, '할머니 혼례', 'Event', '1962-03-10', '1962-03-10', '1962-03-10', 'day'::date_precision, false, false, true, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 3, '어머니 태어남', 'Event', '1963', '1963-01-01', '1963-12-31', 'year'::date_precision, false, false, false, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 4, '아버지 입대', 'Event', '1982-05', '1982-05-01', '1982-06-01', 'month'::date_precision, false, false, true, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 5, '아버지 제대', 'Event', '1985-02', '1985-02-01', '1985-03-01', 'month'::date_precision, false, false, false, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 6, '부모님 결혼', 'Event', '1988-10-09', '1988-10-09', '1988-10-09', 'day'::date_precision, false, false, true, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 7, '나 태어남', 'Event', '1990-04-02', '1990-04-02', '1990-04-02', 'day'::date_precision, false, false, true, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 8, '외할아버지 돌아가심', 'Event', '1996', '1996-01-01', '1996-12-31', 'year'::date_precision, false, false, false, 'public' from bundle where source = '사건';
...
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, access_level) select id, 9, '할머니 서울 이사', 'Event', '1998-11-02', '1998-11-02', '1998-11-02', 'day'::date_precision, false, false, true, 'public' from bundle where source = '사건';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '할머니 처녀 적 사진' and s.label = '인물 사진' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '할머니 처녀 적 사진' and lp.label = '유년기' and pe.display_name like '%(할머니)';
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, description, creator, doc_type, extent, language, place_id, access_level) select b.id, 1, '할머니 혼례 사진', 'StillImage'::dcmi_type, '1962-03-10', '1962-03-10', '1962-03-10', 'day'::date_precision, false, false, true, '전통 혼례를 올리던 날 큰집 마당에서 찍었다.', '미상', '인화 사진', '3장', 'ko', (select id from place where family_name = '큰집 마당'), 'public'::access_level from bundle b where b.source = '할머니댁' and b.title = '안방 장롱';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '할머니 혼례 사진' and s.label = '혼례' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '할머니 혼례 사진' and lp.label = '혼인과 분가' and pe.display_name like '%(할머니)';
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, description, creator, doc_type, extent, language, place_id, access_level) select b.id, 2, '혼인신고서 사본', 'Text'::dcmi_type, '1962-03-10', '1962-03-10', '1962-03-10', 'day'::date_precision, false, false, true, '할머니 혼례 날짜를 확인해 준 문서.', '안동군청', '증명서', '1장', 'ko', null, 'private'::access_level from bundle b where b.source = '기관 발급' and b.title = '안동군청';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '혼인신고서 사본' and s.label = '혼례' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '혼인신고서 사본' and lp.label = '혼인과 분가' and pe.display_name like '%(할머니)';
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, description, creator, doc_type, extent, language, place_id, access_level) select b.id, 3, '시골집 부엌 앞에서', 'StillImage'::dcmi_type, '1962?', '1962-01-01', '1962-12-31', 'year'::date_precision, true, false, false, '새로 들어온 시골집의 부엌 문 앞. 할머니 뒤로 아궁이가 보인다.', '미상', '인화 사진', '1장', 'ko', (select id from place where family_name = '시골집'), 'public'::access_level from bundle b where b.source = '할머니댁' and b.title = '안방 장롱';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '시골집 부엌 앞에서' and s.label = '음식' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '시골집 부엌 앞에서' and lp.label = '자녀 양육기' and pe.display_name like '%(할머니)';
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, description, creator, doc_type, extent, language, place_id, access_level) select b.id, 4, '외갓집 마당에서 찍은 가족사진', 'StillImage'::dcmi_type, '1978-05-14', '1978-05-14', '1978-05-14', 'day'::date_precision, false, false, true, '어린이날 외갓집 마당에 모여 찍었다.', '김영호(외할아버지)', '인화 사진', '2장', 'ko', (select id from place where family_name = '외갓집'), 'public'::access_level from bundle b where b.source = '외갓집' and b.title = '앨범 3권';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '아버지 국민학교 졸업식' and s.label = '학교' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '아버지 국민학교 졸업식' and lp.label = '학창 시절' and pe.display_name like '%(아버지)';
insert into item (bundle_id, seq, title, type, created_edtf, created_start, created_end, created_precision, created_uncertain, created_approx, date_verified, description, creator, doc_type, extent, language, place_id, access_level) select b.id, 8, '국민학교 졸업장', 'PhysicalObject'::dcmi_type, '1973-02-16', '1973-02-16', '1973-02-16', 'day'::date_precision, false, false, true, '아버지의 국민학교 졸업장. 액자에 넣어 두었다.', '풍산국민학교', '상장·증서', '1장', 'ko', null, 'private'::access_level from bundle b where b.source = '부모님댁' and b.title = '서재 문갑';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '국민학교 졸업장' and s.label = '학교' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '국민학교 졸업장' and lp.label = '학창 시절' and pe.display_name like '%(아버지)';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '부모님 결혼식' and s.label = '혼례' and s.parent_id is null;
insert into item_life_period (item_id, life_period_id) select i.id, lp.id from item i, life_period lp join person pe on pe.id = lp.person_id where i.title = '부모님 결혼식' and lp.label = '결혼 이후' and pe.display_name like '%(아버지)';
...
insert into item_subject (item_id, subject_id) select i.id, s.id from item i, subject s where i.title = '외할아버지 영정 사진' and s.label = '상례' and s.parent_id is null;
